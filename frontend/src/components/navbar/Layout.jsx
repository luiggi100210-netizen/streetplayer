        ...
        <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={notifRef}>
              <button
                onClick={abrirNotifs}
                className={`relative w-8 h-8 rounded-lg flex items-center justify-center transition-colors border ${notifAbierto ? 'bg-sp-green/20 border-sp-green text-sp-green' : 'bg-sp-card border-sp-border text-sp-muted hover:border-sp-green hover:text-white'}`}
              >
